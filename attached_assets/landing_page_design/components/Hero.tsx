...
const Counter: React.FC<{ target: number; suffix?: string; label: string }> = ({ target, suffix = '', label }) => {
  ...
  return (
    <div ref={ref}>
      <div className="text-3xl sm:text-4xl text-white font-geist font-light tracking-tighter">
...
export const Hero: React.FC = () => {
  ...
  return (
    <section className="relative lg:pt-24 lg:pb-16 pt-24 pb-12 overflow-hidden">
      {/* Light Beam Animation Background */}
        ...
        <div className="grid grid-cols-1 items-center gap-8 lg:grid-cols-12 xl:gap-16">
          ...
          <div className="relative z-10 lg:col-span-6 xl:col-span-6">
            ...
            <div className="relative z-10">
              <h1 className="animate-slide-up delay-300 text-5xl sm:text-6xl lg:text-7xl xl:text-8xl leading-[0.95] mb-6 font-geist font-light tracking-tighter">
                Heal Your
              ...
              <p className="animate-slide-up delay-500 max-w-2xl text-lg sm:text-xl leading-relaxed text-white/70 mb-6">
              ...
              {/* Stats */}
              <div className="animate-slide-up delay-900 grid grid-cols-2 sm:grid-cols-3 gap-8 mt-12 max-w-2xl">
          ...
          {/* Visuals - Enlarged and Interactive */}
          <div className="relative lg:col-span-6 xl:col-span-6 flex justify-center lg:justify-end mt-8 lg:mt-0">
            {/* Main Visual with Spotlight Effect */}
            <Spotlight 
              className="animate-blur-in delay-500 relative aspect-square w-full max-w-xl overflow-hidden rounded-[2rem] border border-white/10 bg-gradient-to-br from-white/10 to-white/5 ring-1 ring-white/5 shadow-2xl shadow-black/40 group"
