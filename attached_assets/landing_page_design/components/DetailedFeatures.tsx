...
const DetailItem: React.FC<{ icon: React.ReactNode; title: string; desc: string }> = ({ icon, title, desc }) => (
  <Spotlight className="group relative flex gap-4 items-start p-6 rounded-2xl bg-white/5 border border-white/10 hover:bg-white/10 transition-colors duration-300">
...
export const DetailedFeatures: React.FC = () => {
  ...
  return (
    <section className="py-16 lg:py-24 px-4 sm:px-6 relative overflow-hidden" id="what-you-get">
      <div className="max-w-7xl mx-auto relative z-10">
        <div ref={ref} className="scroll-animate">
          <div className="text-center mb-12">
            <h2 className="text-5xl sm:text-6xl lg:text-7xl font-geist font-light tracking-tighter mb-4">
              What you get with 
