  ...
  <Spotlight className="group relative overflow-hidden rounded-2xl border border-white/10 bg-gradient-to-b from-white/10 to-white/5 p-6 backdrop-blur-xl hover:from-white/15 hover:to-white/10 transition-all duration-500">
    <div className="relative h-48 lg:h-52 overflow-hidden rounded-xl ring-1 ring-white/10 mb-6 z-20">
      ...
      <div className="absolute top-3 right-3">
        <button className="inline-flex h-9 w-9 items-center justify-center rounded-lg bg-white/15 ring-1 ring-white/20 backdrop-blur-xl hover:bg-white/25 transition-colors text-white">
          {icon}
        </button>
      </div>
    </div>
    <div className="relative z-20">
      <h3 className="text-xl font-display font-semibold tracking-tight mb-3 text-white">{title}</h3>
    ...
    <section id="learn" className="relative py-16 lg:py-24">
      <div ref={ref} className="scroll-animate mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="rounded-[2rem] border border-white/10 bg-gradient-to-b from-white/5 to-transparent p-6 lg:p-8 ring-1 ring-white/5 shadow-2xl shadow-black/40 relative overflow-hidden">
          {/* Subtle background glow for container */}
