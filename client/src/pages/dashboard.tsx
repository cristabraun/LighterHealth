...
function StressTrendChart() {
  ...
  return (
    <Card className="p-5 space-y-4 bg-white/30 dark:bg-slate-800/30 backdrop-blur-lg border-white/20 dark:border-slate-700/30" data-testid="card-stress-trend">
...
function SleepQualityChart() {
  ...
  return (
    <Card className="p-5 space-y-4 bg-white/30 dark:bg-slate-800/30 backdrop-blur-lg border-white/20 dark:border-slate-700/30" data-testid="card-sleep-quality">
      <div className="flex items-center justify-between">
...
function ConsistencyMeter() {
  ...
  return (
    <Card className="p-5 space-y-4 bg-white/30 dark:bg-slate-800/30 backdrop-blur-lg border-white/20 dark:border-slate-700/30" data-testid="card-consistency">
  ...
  return (
    <div className="min-h-screen pb-24 bg-gradient-to-b from-background via-background to-primary/5">
      ...
      <div className="max-w-4xl mx-auto px-4 md:px-6 py-6 space-y-6">
        ...
        {welcomeExpanded && (
          <Card
            className="p-6 space-y-4 bg-white/30 dark:bg-slate-800/30 backdrop-blur-lg border-white/20 dark:border-slate-700/30"
        ...
        <div className="lg:grid lg:grid-cols-2 lg:gap-6">
          ...
          <div className="space-y-6">
            ...
            <Card className="p-6 space-y-4 bg-white/30 dark:bg-slate-800/30 backdrop-blur-lg border-white/20 dark:border-slate-700/30" data-testid="card-today-snapshot-desktop">
