  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary/10 via-background to-chart-2/10">
      ...
      <div className="max-w-6xl mx-auto px-6 py-8 border-b border-border/40" data-testid="section-features">
        <div className="bg-slate-50 dark:bg-slate-900/30 rounded-lg p-8">
          <div className="grid md:grid-cols-3 gap-6">
            <Card className="flex flex-col gap-4 p-6 bg-white/30 dark:bg-slate-800/30 backdrop-blur-lg border-white/20 dark:border-slate-700/30 h-full" data-testid="card-feature-track">
            ...
            <Card className="flex flex-col gap-4 p-6 bg-white/30 dark:bg-slate-800/30 backdrop-blur-lg border-white/20 dark:border-slate-700/30 h-full" data-testid="card-feature-experiments">
            ...
            <Card className="flex flex-col gap-4 p-6 bg-white/30 dark:bg-slate-800/30 backdrop-blur-lg border-white/20 dark:border-slate-700/30 h-full" data-testid="card-feature-insights">
      ...
      <div className="max-w-4xl mx-auto px-6 py-8 border-b border-border/40" data-testid="section-value">
        <Card className="p-12 space-y-8 bg-white/30 dark:bg-slate-800/30 backdrop-blur-lg border border-white/20 dark:border-slate-700/30">
          <div>
